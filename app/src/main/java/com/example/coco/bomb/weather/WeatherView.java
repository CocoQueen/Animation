        ...
        if (flowerAnim==null){
            ...
            flowerAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    mRectSunFlower.set(getMeasuredWidth()/2f-width/2,getMeasuredHeight()/2f-width/2
